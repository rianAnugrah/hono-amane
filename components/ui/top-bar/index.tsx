...
const LocationDisplay = ({ size = 2 }: { size: number }) => {
        ...
        <div className="">
          <div className="dropdown dropdown-end w-full h-full cursor-pointer hover:font-bold">
            <div tabIndex={0} role="button" className="">
              <span className="bg-gray-50 rounded-full w-5 h-5 text-xs p-1">
                +{location.length - size}
              </span>
            </div>
            <div
  ...
  return (
    <div className="dropdown dropdown-end dropdown-hover cursor-pointer">
      <div
        tabIndex={0}
        role="button"
        className="flex gap-4 items-center   rounded-lg w-[18rem] p-2"
      >
