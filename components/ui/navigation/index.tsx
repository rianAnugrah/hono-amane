  ...
  return (
    <>
      ...
      {typeof document !== 'undefined' && createPortal(
        <AnimatePresence>
          {menuOpen && (
            <div className="drawer-container" style={{ position: 'relative', zIndex: 10000 }}>
              {/* Overlay */}
              <motion.div
...
function DesktopNav() {
  ...
  return (
    <nav className={`hidden md:flex flex-col h-[100svh] gap-1 ${isCompact ? 'w-[4.5rem]' : 'w-[15rem]'} transition-all duration-300 ${isCompact ? 'pl-3 pr-3' : 'pl-12 pr-7'} pb-4 relative`}>
